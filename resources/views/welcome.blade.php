...
<body class="antialiased">
    ...
    <main>
        ...
        <div class="center mt-5 pt-5 pb-5">
            <h1 class="text-center text-white mt-5">CARP</h1>
            <h3 class="text-center text-white h5">車好きの名刺サイト</h3>
        ...
        <div class="sample-card mx-auto w-50 p-3 bg-white mt-5 rounded">
            <div class="content">
                <div class="image-name d-flex">
                    ...
                    <div class="name ml-5 mt-4 pt-2">
                        <h3>CARP DEV</h3>
                    </div><!-- /.name -->
                </div><!-- /.image-name -->

                <div class="infomation mt-3">
                    <table>
                        <tr>
                            <th>愛車</th>
                            <td>マツダ３</td>
        ...
        <div class="get-started w-50 mx-auto mt-5">
            @if (Route::has('login'))
                <div class="px-6 mt-3 sm:block d-flex justify-content-around">
                    @auth
                        <a href="{{ url('/home') }}" class="text-gray-700 dark:text-gray-500 h3 text-white bg-info px-4 py-2 rounded-pill">さっそくはじめる</a>
                    @else
                        <a href="{{ route('login') }}" class="text-gray-700 dark:text-gray-500 h3 text-white bg-info px-4 py-2 rounded-pill">ログイン</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 text-gray-700 dark:text-gray-500 h3 text-white bg-info px-4 py-2 rounded-pill">
                                新規登録
                            </a>
                        @endif
                    @endauth
